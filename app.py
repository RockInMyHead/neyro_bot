...
Требования:
- Напиши ОДНО предложение длиной НЕ БОЛЕЕ 100 символов
...
- ОБЯЗАТЕЛЬНО соблюдай лимит в 100 символов

Пример стиля:
"Погружаясь в мрачную атмосферу пиратских кораблей, зритель отправляется в эпическое плавание по волнам приключений."
"""
