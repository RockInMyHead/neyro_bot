...
Требования:
- Напиши ОДНО ЗАВЕРШЕННОЕ предложение длиной НЕ БОЛЕЕ 250 символов
...
- Строго соблюдай лимит в 250 символов
...
ВАЖНО: Описание должно быть ЗАВЕРШЕННЫМ и не обрываться на середине предложения!
"""
        ...
        try:
            ...
            if len(description) > 250:
                ...
                if last_sentence_end > 50:  # Если есть завершенное предложение
